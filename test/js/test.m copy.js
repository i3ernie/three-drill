...
const myDriller = new Driller({translation:true});
...
//jetzt wird gebohrt
myDriller.setDriller( driller ).drill( box );
myDriller.setDriller( driller2 ).drill( box );
myDriller.setDriller( driller3 ).drill( box );
